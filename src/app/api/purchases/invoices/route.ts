...
// GET: Get all purchase invoices for the current company
...
export async function POST(request: NextRequest) {
    try {
        ...
        if (status === 'confirmed' && supplier_id) {
