...
INSERT INTO companies (id, code, name, name_ar, email, phone, city, country, currency, is_active)
VALUES 
    ('a1a1a1a1-a1a1-a1a1-a1a1-a1a1a1a1a1a1', 'DEMO-001', 'Demo Company', 'الشركة التجريبية', 'info@demo.com', '01000000000', 'القاهرة', 'مصر', 'EGP', true)
...
VALUES 
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'admin@demo.com', '$2a$10$demo123hashedpasswordexample', 'Admin User', 'المدير', '01111111111', 'active')
ON CONFLICT (id) DO NOTHING;
